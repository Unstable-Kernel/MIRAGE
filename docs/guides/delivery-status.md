...
| M4, goal-to-evaluate workflow | Foundation implemented | Bounded review-only goal, EIR-bound steps, criteria, policy-bound checkpoint, deterministic plan, evidence assessment, redacted context bundle, review trace, approval chain, advisory eligibility, persistence interface, revocation review, provenance seal, and lifecycle validation; no planning model or execution pipeline |
...
| 3 | M4 goal-to-evaluate workflow | Review-only goal, EIR-bound steps, criteria, checkpoint, deterministic plan, evidence assessment, redacted context bundle, review trace, approval chain, advisory eligibility, persistence interface, revocation review, provenance seal, and lifecycle validation exist, but no integrated engineering workflow exists | Controlled context inputs, real evidence collection, policy-bound evaluation, authenticated approval persistence and transitions, report artifacts, and integration tests |

...
The current implementation establishes a real foundation rather than claiming the full long-term platform. It delivers EIR 0.1 validation, provenance-preserving local JSON and YAML EIR ingestion, a provider-neutral model orchestrator, six model-provider adapters, revisioned ESG snapshots, a policy-gated URCP runtime, an audit ledger, checkpoint revalidation, sandbox assessment, deterministic fixture-backed read-only simulator inspection, transport verification manifests, sandbox enforcement-evidence contracts, and non-executing goal-to-evaluate workflow review with deterministic EIR-to-plan, evidence assessment, context bundles, review traces, review-trace event consistency, policy-provenance consistency, review-policy evidence-reference consistency, evidence-capture declaration consistency, evidence-capture lineage consistency, approval chains, advisory dispatch eligibility, persistence interface definitions, revocation review, provenance seals, lifecycle validation, controlled context schemas, deterministic report artifacts, cross-artifact consistency, reference-only provenance consistency, report-seal consistency, deterministic review policy, and unified readiness assessment. Real simulator transport, host-level sandbox enforcement, simulator control, autonomous experiment loops, and physical-hardware integration remain roadmap work.
...
uv run mirage eir-ingest examples/16-eir-ingestion/robot_model.json
...
uv run mirage workflow-readiness-assess examples/09-deterministic-workflow/workflow.json examples/01-validate-eir/robot_model.yaml examples/10-context-review/context.json examples/09-deterministic-workflow/evidence.json examples/10-context-review/review-trace.json examples/11-guarded-approval/approval-chain.json examples/13-controlled-report/context-schema.json examples/13-controlled-report/context-envelope.json examples/12-governance-foundations/evidence-seals.json examples/13-controlled-report/report.json examples/13-controlled-report/report-seal.json examples/14-cross-artifact-readiness/review-policy.json examples/08-parallel-foundations/transport-manifest.json examples/08-parallel-foundations/transport-evidence.json examples/11-guarded-approval/sandbox-assessment.json
uv run pytest
```
...
| `mirage validate`, `mirage inspect`, `mirage eir-ingest`, `mirage doctor` | Implemented |
...
| Cross-artifact readiness | Implemented as local consistency and policy review; no dispatch, transport, sandbox enforcement, or execution is claimed |
| Provenance consistency assessment | Implemented as a local EIR, evidence-seal, and report-reference comparison; no evidence retrieval, signature verification, report mutation, or execution is claimed |
| Report seal consistency assessment | Implemented as a local report, seal, and trace declaration comparison; no report hashing, signature verification, trusted timestamp, remote witness, mutation, or execution is claimed |
| Review-trace event consistency assessment | Implemented as a local trace, event, and policy declaration comparison; no artifact retrieval, digest recomputation, signature verification, mutation, or execution is claimed |
| Policy-provenance consistency assessment | Implemented as a local policy, context, trace, report, and review-policy declaration comparison; no retrieval, signature verification, remote witness, mutation, or execution is claimed |
| Review-policy evidence-reference consistency assessment | Implemented as a local review-policy, report, evidence-provenance, and seal declaration comparison; no retrieval, signature verification, remote witness, mutation, or execution is claimed |
| Evidence-capture declaration consistency assessment | Implemented as a local capture, provenance-seal, review-policy evidence, and report-reference declaration comparison; no retrieval, signature verification, remote witness, mutation, or execution is claimed |
| Evidence-capture lineage consistency assessment | Implemented as a local capture graph and capture-assessment declaration comparison; no retrieval, ordering claim, signature verification, remote witness, mutation, or execution is claimed |
...
Read [ARCHITECTURE.md](ARCHITECTURE.md) for the system boundaries, [specs/EIR/eir-0.1.md](specs/EIR/eir-0.1.md) for the canonical semantic contract, [docs/guides/eir-ingestion.md](docs/guides/eir-ingestion.md) for controlled local EIR candidate ingestion, [docs/guides/provenance-consistency.md](docs/guides/provenance-consistency.md) for reference-only EIR, evidence, and report consistency assessment, [docs/guides/report-seal-consistency.md](docs/guides/report-seal-consistency.md) for local report, seal, and trace declaration assessment, [docs/guides/review-trace-event-consistency.md](docs/guides/review-trace-event-consistency.md) for local review-trace event and policy declaration assessment, [docs/guides/policy-provenance-consistency.md](docs/guides/policy-provenance-consistency.md) for local policy, context, trace, report, and review-policy declaration assessment, [docs/guides/review-policy-evidence-consistency.md](docs/guides/review-policy-evidence-consistency.md) for local review-policy, report, evidence-provenance, and seal declaration assessment, [docs/guides/evidence-capture-consistency.md](docs/guides/evidence-capture-consistency.md) for local capture, provenance-seal, review-policy evidence, and report-reference declaration assessment, [docs/guides/evidence-capture-lineage-consistency.md](docs/guides/evidence-capture-lineage-consistency.md) for local capture lineage declaration assessment, [specs/ESG/README.md](specs/ESG/README.md) for state history, [specs/URCP/README.md](specs/URCP/README.md) for capability declarations, [docs/guides/urcp-execution.md](docs/guides/urcp-execution.md) for execution policy, [docs/guides/execution-hardening.md](docs/guides/execution-hardening.md) for timeout and cancellation behavior, [docs/guides/read-only-simulator-adapter.md](docs/guides/read-only-simulator-adapter.md) for metadata and state extraction boundaries, [docs/guides/parallel-foundations.md](docs/guides/parallel-foundations.md) for the transport, sandbox, and M4 foundation contracts, [docs/guides/deterministic-workflow-evidence.md](docs/guides/deterministic-workflow-evidence.md) for EIR-bound planning and evidence review, [docs/guides/context-review-trace.md](docs/guides/context-review-trace.md) for context and provenance review, [docs/guides/guarded-approval-eligibility.md](docs/guides/guarded-approval-eligibility.md) for approval and advisory dispatch checks, [docs/guides/governance-foundations.md](docs/guides/governance-foundations.md) for persistence, revocation, provenance, and lifecycle contracts, [docs/guides/controlled-context-report.md](docs/guides/controlled-context-report.md) for schema-bound context and deterministic reports, [docs/guides/cross-artifact-readiness.md](docs/guides/cross-artifact-readiness.md) for unified review readiness, [docs/guides/sandbox-checkpoint-revalidation.md](docs/guides/sandbox-checkpoint-revalidation.md) for sandbox and checkpoint safety, [docs/guides/execution-ledger.md](docs/guides/execution-ledger.md) for audit and checkpoint behavior, [docs/guides/model-providers.md](docs/guides/model-providers.md) for all six provider integrations, [docs/guides/distribution.md](docs/guides/distribution.md) for release readiness, [docs/guides/delivery-status.md](docs/guides/delivery-status.md) for the quantified baseline and remaining delivery streams, and [docs/guides/core-features.md](docs/guides/core-features.md) for the upcoming core roadmap. Development rules are in [CONTRIBUTING.md](CONTRIBUTING.md), the security model is in [SECURITY.md](SECURITY.md), and the delivery path is in [ROADMAP.md](ROADMAP.md).
